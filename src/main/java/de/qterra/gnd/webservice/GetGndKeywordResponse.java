 ...
 */
            ...
            /**
            *  GetGndKeywordResponse bean class
            */
        
        public  class GetGndKeywordResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://gnd.hbz.nrw.de/webservice/",
                "getGndKeywordResponse",
                "ns1");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected de.qterra.gnd.webservice.KeywordResultType[] localResult ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return de.qterra.gnd.webservice.KeywordResultType[]
                           */
                           public  de.qterra.gnd.webservice.KeywordResultType[] getResult(){
                               return localResult;
                           }
                               ...
                               */
                              protected void validateResult(de.qterra.gnd.webservice.KeywordResultType[] param){
                              ...
                              * @param param Result
                              */
                              public void setResult(de.qterra.gnd.webservice.KeywordResultType[] param){
                             ...
                             * @param param de.qterra.gnd.webservice.KeywordResultType
                             */
                             public void addResult(de.qterra.gnd.webservice.KeywordResultType param){
                                   if (localResult == null){
                                   localResult = new de.qterra.gnd.webservice.KeywordResultType[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localResult);
                               list.add(param);
                               this.localResult =
                             (de.qterra.gnd.webservice.KeywordResultType[])list.toArray(
                            new de.qterra.gnd.webservice.KeywordResultType[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetGndKeywordResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getGndKeywordResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getGndKeywordResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetGndKeywordResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetGndKeywordResponse object =
                new GetGndKeywordResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getGndKeywordResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetGndKeywordResponse)de.qterra.gnd.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list2.add(de.qterra.gnd.webservice.KeywordResultType.Factory.parse(reader));
                                                        ...
                                                        object.setResult((de.qterra.gnd.webservice.KeywordResultType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                de.qterra.gnd.webservice.KeywordResultType.class,
                                                                list2));
