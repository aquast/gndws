 ...
 */
    ...
    public class GndRequesterSkeleton implements GndRequesterSkeletonInterface{
         ...
         */
            ...
            {
                //TODO : fill this with the necessary business logic
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#getResourcesByIdentifier");
        }
         ...
         */
            ...
            {
                //TODO : fill this with the necessary business logic
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#getResourcesByPnd");
        }
