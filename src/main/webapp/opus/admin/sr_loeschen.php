 ...
 * @version     $Id: sr_loeschen.php 214 2007-05-17 10:28:15Z freudenberg $
 */
#############################################################
# letzte Änderung:
#
...
if ($num > 0) {
    ...
    $design->foot("sr_loeschen.$php", $la);
    exit();
}
...
if (($num+$num2) > 0) {
    ...
    print ("<H3>Soll die Schriftenreihe $sr_name wirklich gel&ouml;scht werden</H3> <br>
<table>
<tr>
<td>
<FORM METHOD = \"POST\" ACTION = \"$url/admin/sr_delete.$php\">
