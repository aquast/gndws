 ...
 * @version     $Id: collections_umbenennen.php 214 2007-05-17 10:28:15Z freudenberg $
 */
#############################################################
# letzte Änderung:
#
...
$titel = $opus->value("titel_collections_umbenennen");
$ueberschrift = $opus->value("ueberschrift_collections_umbenennen");
...
$query = "SELECT coll1.coll_id, coll1.coll_name, 
		...
		GROUP BY coll1.lft;";
//	echo "<p>Query ist $query</p>";
$res = $opus->query($query);
$num = $opus->num_rows($res);
//	echo "<p>Num ist $num</p>";
if ($num > 0) {
    $i = 0;
    //		echo "<p>Eishockey</p>";
    while ($i < $num) {
...
$opus->close($sock);
$design->foot("collections_umbenennen.$php", $la);
?>
