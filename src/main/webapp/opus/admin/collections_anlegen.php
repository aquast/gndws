 ...
 * @version     $Id: collections_anlegen.php 214 2007-05-17 10:28:15Z freudenberg $
 */
##############################################
# letzte Änderung:
#
...
# In Abhaengigkeit von $la kann das entsprechende
# Design eingelesen werden.
###############################################
...
$titel = $opus->value("titel_collections_anlegen");
$ueberschrift = $opus->value("ueberschrift_collections_anlegen");
...
if ($num > 0) { // Es gibt bereits Einträge in der Tabelle collections
    print ("<form method=\"post\" action=\"$url/admin/collections_siblings.$php\">
	<table border=0><tr>
	<td>Name der neuen Collection:</td>
	<td><input name=\"coll_name\" type=\"text\" size=\"40\">
	</tr>
	<tr><td colspan=2>
	<p>Bitte w&auml;hlen Sie die Mutter-Collection der neuen Collection aus. Die neue Collection wird eine Unter-Collection der ausgew&auml;hlten Collection sein.</p>
	<p><b>Hinweis:</b> auf der obersten Hierarchiestufe darf nur <b>ein</b> Element erzeugt werden. Benennen Sie daher die oberste Hierarchie am besten nach Ihrer Institution.
	<p>
	");
    ...
    if ($num > 0) {
        ...
        while ($i < $num) {
            ...
            print ("$indent <input type=\"radio\" name=\"coll_before\" value=\"$coll_id\">$coll_name (Anzahl Untercollections: $children)<br>
			");
            $i++;
        }
...
$opus->close($sock);
$design->foot("collections_anlegen.$php", $la);
?>
