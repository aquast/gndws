 ...
 *
 */
public class TestGndRequesterAsClient {

	/**
	 * Default Constructor for getting Configuration and set up logging
	 */
	public TestGndRequesterAsClient(){
		Configuration.initLog();
	}

	// Initiate Logger for TestGndRequesterAsClient
	private static Logger log = Logger.getLogger(TestGndRequesterAsClient.class);

	public void gndRequest() {
		...
		if(res != null){
			...
			log.info("Example: " + res[0].getPndUri());
			log.info("Example: " + res[0].getPrefferedName());
			log.info("Example: " + res[0].getYearOfBirth());
			log.info("Example: " + res[0].getBiograficData());
			log.info("Example: " + res[0].getWpUrl()[0]);
		}
		else{
	...
	public static void main(String[] args) {
		...
		TestGndRequesterAsClient client = new TestGndRequesterAsClient();
		client.gndRequest();
